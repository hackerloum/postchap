    ...
    >
      <div className="p-4 border-b" style={{ borderColor: "var(--studio-border-subtle)" }}>
        <Link href="/studio" className="flex items-center gap-2">
          ...
          />
          <span
            className="studio-font-ui text-[10px] font-medium tracking-wider"
      ...
      >
        <p className="studio-font-display text-[13px] font-semibold truncate" style={{ color: "var(--studio-text-primary)" }}>
          {agencyName}
        </p>
        <p className="studio-font-ui text-[8px] mt-0.5 tracking-widest" style={{ color: "var(--studio-text-muted)" }}>
          {plan}
        </p>
      </div>
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 studio-font-ui text-[11px] tracking-wide ${
      ...
      <div className="p-3 border-t space-y-2" style={{ borderColor: "var(--studio-border-subtle)" }}>
        <Link
          href="/dashboard"
          className="flex items-center justify-center gap-2 py-2 rounded-lg border studio-font-ui text-[10px] tracking-widest transition-colors duration-150 hover:border-[var(--studio-accent)] hover:text-[var(--studio-accent)]"
        ...
        <div className="relative">
          <button
            ...
            className="w-full flex items-center gap-3 p-2 rounded-lg transition-colors duration-150 hover:bg-white/5"
            style={{ color: "var(--studio-text-secondary)" }}
          >
            <div
              className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 studio-font-display text-sm font-semibold"
              style={{
            ...
            <div className="flex-1 min-w-0 text-left">
              <p className="studio-font-ui text-[10px] truncate" style={{ color: "var(--studio-text-primary)" }}>
                Account
              </p>
              <p className="studio-font-ui text-[8px] truncate" style={{ color: "var(--studio-text-muted)" }}>
                {plan}
              </p>
            </div>
          </button>
            ...
            <>
              ...
              >
                <Link
                  ...
                  className="flex items-center gap-2 px-3 py-2 studio-font-ui text-[11px] hover:bg-white/5 transition-colors"
                  style={{ color: "var(--studio-text-secondary)" }}
