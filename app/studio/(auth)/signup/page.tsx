...
export default function StudioSignupPage() {
  ...
  async function handleSession(token: string) {
    ...
    // Always send Studio users into Studio (layout will show onboarding if no agency)
    router.push("/studio");
  }
    ...
    <div className="animate-fade-up">
      <div className="mb-8">
        ...
        <p className="font-mono text-[13px] text-text-muted">
          For agencies and designers. Separate from your business account.
        </p>
      </div>
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-bg-surface border border-border-default rounded-xl px-4 py-3 pr-12 text-[14px] text-text-primary placeholder:text-text-muted outline-none focus:border-info transition-colors min-h-[48px]"
            />
            <button
              type="button"
      ...
      <p className="text-center font-mono text-[11px] text-text-muted mt-4 leading-relaxed">
        ...
        <Link href="/terms" className="text-text-secondary hover:text-info transition-colors">
          Terms
        </Link>{" "}
        and{" "}
        <Link href="/privacy" className="text-text-secondary hover:text-info transition-colors">
          Privacy Policy
        </Link>
      </p>
      ...
      <p className="text-center font-mono text-[13px] text-text-muted mt-4">
        ...
        <Link
          href="/studio/login"
          className="text-text-primary hover:text-info transition-colors font-semibold"
        >
          Sign in
        </Link>
      </p>
